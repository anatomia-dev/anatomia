...
FAIL means Verify found issues — this is the pipeline working as designed. 19 of our 90 proofs had rejection cycles. {/* ana:dynamic rejectionProofCount */}
...
<NextCards cards={[
  ...
  },
  {
    ...
    title: "Proof chain",
    href: "/docs/proof",
    description: "90 verified pipeline runs." /* ana:dynamic proofSummary */
  }
]} />
