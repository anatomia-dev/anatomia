...
description: Common problems grouped by when you hit them.
lastReviewed: May 2026
---

# Troubleshooting

Common problems grouped by when you hit them. If none of these match, email [help@anatomia.dev](mailto:help@anatomia.dev) with your CLI version (`ana --version`) and the proof slug if applicable.
