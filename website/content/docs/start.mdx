...
**Verify detected commands.** The Test, Build, and Lint lines above are project-wide commands inferred from your package.json. For monorepos, `buildPackage` and `testPackage` target your primary package specifically. Override with `ana config set commands.test "your-command"` if needed.
</Callout>
