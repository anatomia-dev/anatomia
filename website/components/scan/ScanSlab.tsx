          ...
          >
            ...
            <div className="mb-4.5 rounded-lg border p-3" style={{ borderColor: "rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.03)" }}>
              <div className="flex flex-wrap items-baseline justify-between gap-3">
                <span className="text-[15px] font-semibold" style={{ color: "var(--terminal-fg)" }}>inbox-zero</span>
            ...
            <div className="mt-4">
              ...
              <div className="grid gap-y-0.5" style={{ gridTemplateColumns: "92px 1fr" }}>
                ...
                <span><span style={{ color: "#67e8f9" }}>Better Auth</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>AI</span>
                <span><span style={{ color: "#67e8f9" }}>Vercel AI</span> <span style={{ color: "rgba(255,255,255,0.45)" }}>·</span> <span style={{ color: "#67e8f9" }}>OpenAI</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>Payments</span>
                <span><span style={{ color: "#67e8f9" }}>Stripe</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>Testing</span>
                <span><span style={{ color: "#67e8f9" }}>Vitest</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>UI</span>
                <span><span style={{ color: "#67e8f9" }}>Tailwind CSS</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>Services</span>
                <span><span style={{ color: "#67e8f9" }}>Resend</span> <span style={{ color: "rgba(255,255,255,0.45)" }}>·</span> <span style={{ color: "#67e8f9" }}>Sentry</span> <span style={{ color: "rgba(255,255,255,0.45)" }}>·</span> <span style={{ color: "#67e8f9" }}>PostHog</span> <span style={{ color: "rgba(255,255,255,0.45)" }}>(+2 more)</span></span>
            ...
            {/* Surfaces group */}
            <div className="mt-4">
              <div className="mb-1.5 text-[10.5px] uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.45)" }}>Surfaces</div>
              <div className="grid gap-y-0.5" style={{ gridTemplateColumns: "92px 1fr" }}>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>web</span>
                <span><span style={{ color: "#67e8f9" }}>Next.js</span> <span style={{ color: "rgba(255,255,255,0.45)" }}>·</span> <span style={{ color: "#67e8f9" }}>Vitest</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>api</span>
                <span><span style={{ color: "#67e8f9" }}>TypeScript</span> <span style={{ color: "rgba(255,255,255,0.45)" }}>·</span> <span style={{ color: "#67e8f9" }}>Vitest</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>cli</span>
                <span><span style={{ color: "#67e8f9" }}>TypeScript</span></span>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="grid gap-y-0.5" style={{ gridTemplateColumns: "92px 1fr" }}>
                ...
                <span>README.md <span style={{ color: "rgba(255,255,255,0.45)" }}>·</span> CONTRIBUTING.md <span style={{ color: "rgba(255,255,255,0.45)" }}>+ 2 more</span></span>
                <span style={{ color: "rgba(255,255,255,0.55)" }}>Pre-commit</span>
                <span>typecheck + lint</span>
              </div>
            </div>
