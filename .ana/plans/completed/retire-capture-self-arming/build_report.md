...
<!-- ana:capture stage=build slug=retire-capture-self-arming bytes=245683 sha256=486bb9acfa2de0887effcfe83e85a46c9e2e80015e91a57dcaefb8bc1d9ecd92 file=.captures/test-build-1780737634.log counts=abstain verdict=abstain -->
<!-- ana:capture-begin bytes=245683 sha256=486bb9acfa2de0887effcfe83e85a46c9e2e80015e91a57dcaefb8bc1d9ecd92 -->
...
anatomia-cli:build: cache miss, executing fbdc6b515e4f548a
anatomia-cli:build: 
...
anatomia-cli:build: ESM ⚡️ Build success in 35ms
anatomia-cli:test: cache miss, executing f7c1c0afecc4605e
anatomia-cli:test: 
...
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test: [90mstdout[2m | tests/commands/artifact.test.ts[2m > [22m[2mana artifact save[2m > [22m[2mcapture gate — config enablement[2m > [22m[2minlines and seals the verify report's own capture account when saved
anatomia-cli:test: [22m[39m✓ verify_data.yaml validated (1 findings, 1 warnings)
anatomia-cli:test: ✓ Saved Verify report for `test-slug` on `feature/test-slug`.
anatomia-cli:test: 
anatomia-cli:test: [90mstderr[2m | tests/commands/artifact.test.ts[2m > [22m[2mana artifact save[2m > [22m[2mcapture gate — config enablement[2m > [22m[2minlines and seals the verify report's own capture account when saved
anatomia-cli:test: [22m[39mWarning: verify_data.yaml Finding 1 references "src/test.ts" which does not exist.
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/git-activity.test.ts [2m([22m[2m13 tests[22m[2m)[22m[33m 4855[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m reports files by commit count [33m 519[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m filters to source file extensions only [33m 346[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m includes .md files inside src/ directories [33m 382[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m excludes root-level markdown [33m 392[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m caps at 10 files maximum [33m 396[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m counts distinct contributors [33m 336[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m always returns exactly 4 entries [33m 587[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m buckets commits into weeks, newest first [33m 501[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m uses 30 days for repos with <= 300 commits [33m 325[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns null for shallow clone [33m 390[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m produces expected output for Anatomia repo [33m 426[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/init/commit.test.ts [2m([22m[2m45 tests[22m[2m)[22m[33m 5748[2mms[22m[39m
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/utils/worktree.test.ts [2m([22m[2m35 tests[22m[2m)[22m[33m 6355[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m installs dependencies when lockfile exists [33m 825[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m creates worktree from existing branch (in-flight migration) [33m 398[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m worktree can be both ahead and behind at the same time [33m 301[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m initializes submodules when .gitmodules exists [33m 329[2mms[22m[39m
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/work-merge.test.ts [2m([22m[2m22 tests[22m[2m)[22m[33m 7276[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m uses configured squash merge strategy [33m 475[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m infers merge strategy from single allowed method [33m 400[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m infers squash strategy from single allowed method [33m 446[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m infers rebase strategy from single allowed method [33m 453[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m shows branch protection guidance when policy prohibits merge [33m 365[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m handles malformed gh pr view response [33m 423[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m skips merge when PR is already merged [33m 438[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m already-merged path with --json produces valid JSON [33m 398[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m merge-succeeded path with --json produces valid JSON [33m 424[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/git-workflow.test.ts [2m([22m[2m19 tests[22m[2m)[22m[33m 7905[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects conventional commits with high confidence [33m 526[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects non-conventional commits [33m 496[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m reports correct confidence for mixed formats [33m 481[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m handles repo with single commit [33m 379[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns empty prefixes for repo with no remote branches [33m 338[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects branch patterns from GitHub PR merge subjects [33m 1222[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m parses git CLI merge branch format [33m 508[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m excludes bot branches from merge-based detection [33m 526[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m falls back to remote branches when no merge history [33m 311[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns null primary when default branch is unknown [33m 310[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m skips unparseable merge subjects without error [33m 496[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects Husky pre-commit hook with test and lint [33m 367[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns exists: false when no hooks directory [33m 326[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects .git/hooks/pre-commit when no Husky [33m 328[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m reports squash/rebase for repo with zero merge commits [33m 420[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects Co-authored-by trailer [33m 362[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns detected: false when no trailers [33m 312[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:   Committed locally. Push failed after retry — run `git push`
anatomia-cli:test:  [32m✓[39m tests/commands/check.test.ts [2m([22m[2m18 tests[22m[2m)[22m[33m 3771[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m passes when cited file exists [33m 309[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/detection-overrides.test.ts [2m([22m[2m21 tests[22m[2m)[22m[33m 3429[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects TypeScript when tsconfig.json exists alongside package.json [33m 592[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects TypeScript when typescript is only in root devDependencies (monorepo) [33m 428[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m does not override language for non-Node projects with subdirectory tsconfig [33m 358[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m parses postgresql provider from prisma schema [33m 386[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/e2e/init-flow.test.ts [2m([22m[2m6 tests[22m[2m)[22m[33m 9746[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m creates all expected files in .ana/ (context, docs, plans, hooks, state) [33m 1040[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m re-init preserves context/ files (user enrichment) but refreshes state/ [33m 2515[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m re-init preserves plans/active/ (in-flight pipeline work survives) [33m 2350[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m init failure leaves existing .ana/ untouched (NEW-001 swap safety) [33m 1844[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m creates scan.json with full engine result when analysis runs [33m 1024[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m scaffolds conditional skill directories when scan detects triggers [33m 972[2mms[22m[39m
anatomia-cli:test:   Committed locally. Push failed after retry — run `git push`
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/git-detection.test.ts [2m([22m[2m10 tests[22m[2m)[22m[33m 3613[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m detects default branch via common names when no remote [33m 310[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns non-empty array on Anatomia repo [33m 322[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m excludes local-only branches when remote exists [33m 466[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m excludes bot branches from branch list [33m 661[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m excludes bot prefixes from branchPatterns [33m 1160[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:   Committed locally. Push failed after retry — run `git push`
anatomia-cli:test:  [32m✓[39m tests/commands/learn.test.ts [2m([22m[2m6 tests[22m[2m)[22m[33m 2340[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m writes a timestamp to state.json [33m 403[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m creates a git commit with [learn] prefix [33m 322[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m exits with error when not on artifact branch [33m 370[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows how many findings will be old next time [33m 447[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m creates .ana/learn/ if it does not exist [33m 338[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns JSON with command field [33m 457[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test: Run `ana work status` to see completed work items.
anatomia-cli:test:  [32m✓[39m tests/engine/performance/parsing-performance.test.ts [2m([22m[2m3 tests[22m[2m)[22m[33m 1002[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m parses 20 files in ≤5 seconds [33m 327[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m achieves ≥80% cache speedup on second run [33m 350[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m memory usage stays ≤500MB during parsing [33m 324[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/commands/symbol-index.test.ts [2m([22m[2m11 tests[22m[2m)[22m[33m 3449[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m extracts functions, classes, and methods [33m 491[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m handles arrow functions assigned to const [33m 418[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m marks exported vs non-exported correctly [33m 381[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m verifies symbol is near cited line numbers [33m 354[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m passes when symbol is within tolerance of cited lines [33m 455[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/commands/pr.test.ts [2m([22m[2m12 tests[22m[2m)[22m[33m 2537[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m pr create warning uses slug-based check [33m 333[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m pr create warns when branch does not match slug [33m 331[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/doctor.test.ts [2m([22m[2m40 tests[22m[2m)[22m[33m 2063[2mms[22m[39m
anatomia-cli:test: - Creating directory structure...
anatomia-cli:test: ✔ Directory structure created
...
anatomia-cli:test: - Creating directory structure...
anatomia-cli:test: ✔ Directory structure created
anatomia-cli:test:  [32m✓[39m tests/utils/proofSummary.test.ts [2m([22m[2m119 tests[22m[2m)[22m[33m 2107[2mms[22m[39m
...
anatomia-cli:test: - Creating directory structure...
anatomia-cli:test: ✔ Directory structure created
anatomia-cli:test:  [32m✓[39m tests/commands/test-command.test.ts [2m([22m[2m12 tests[22m[2m)[22m[33m 637[2mms[22m[39m
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/init.test.ts [2m([22m[2m57 tests[22m[2m)[22m[33m 999[2mms[22m[39m
anatomia-cli:test: - Scanning project...
anatomia-cli:test:  [32m✓[39m tests/utils/git-operations.test.ts [2m([22m[2m41 tests[22m[2m)[22m[33m 621[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/commands/agents.test.ts [2m([22m[2m27 tests[22m[2m)[22m[33m 402[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/config.test.ts [2m([22m[2m42 tests[22m[2m)[22m[33m 524[2mms[22m[39m
anatomia-cli:test: - Scanning project...
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/sampling/proportional-sampler.test.ts [2m([22m[2m10 tests[22m[2m)[22m[33m 506[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m uses default budget of 750 [33m 359[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/integration/wasm-smoke.test.ts [2m([22m[2m1 test[22m[2m)[22m[33m 494[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m scanProject deep tier parses real files and returns conventions/patterns [33m 494[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/documentation.test.ts [2m([22m[2m27 tests[22m[2m)[22m[33m 494[2mms[22m[39m
anatomia-cli:test: - Creating directory structure...
anatomia-cli:test: ✔ Directory structure created
anatomia-cli:test:  [32m✓[39m tests/commands/setup-completion.test.ts [2m([22m[2m17 tests[22m[2m)[22m[33m 345[2mms[22m[39m
...
anatomia-cli:test: - Creating directory structure...
anatomia-cli:test: ✔ Directory structure created
anatomia-cli:test:  [32m✓[39m tests/commands/init/template-propagation.test.ts [2m([22m[2m22 tests[22m[2m)[22m[33m 13527[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m a fresh install writes templates with no overwrite warning [33m 1383[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m a Claude-only project never creates or touches the .codex tree [33m 3326[2mms[22m[39m
...
anatomia-cli:test: [22m[39m┌─────────────────────────────────────────────────────────────────────┐
anatomia-cli:test: │  worktree-guard-test-E3EYdp                                         │
anatomia-cli:test: └─────────────────────────────────────────────────────────────────────┘
anatomia-cli:test: 
...
anatomia-cli:test: 
anatomia-cli:test: ✔ Created ana.json
anatomia-cli:test:  [32m✓[39m tests/commands/worktree-guards.test.ts [2m([22m[2m5 tests[22m[2m)[22m[33m 565[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m warns about worktree but does not exit with code 1 [33m 522[2mms[22m[39m
anatomia-cli:test: - Creating ana.json...
anatomia-cli:test: ✔ Created ana.json
anatomia-cli:test: - Creating ana.json...
anatomia-cli:test: ✔ Created ana.json
...
anatomia-cli:test: - Creating ana.json...
anatomia-cli:test: ✔ Created ana.json
anatomia-cli:test:  [32m✓[39m tests/engine/integration/structure-analysis.test.ts [2m([22m[2m5 tests[22m[2m)[22m[33m 449[2mms[22m[39m
anatomia-cli:test: - Scanning project...
anatomia-cli:test:  [32m✓[39m tests/engine/cache/astCache.test.ts [2m([22m[2m17 tests[22m[2m)[22m[33m 357[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/scaffolds/all-scaffolds.test.ts [2m([22m[2m24 tests[22m[2m)[22m[32m 54[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/skill-seeding.test.ts [2m([22m[2m8 tests[22m[2m)[22m[33m 14176[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m injects ## Detected section into coding-standards [33m 1443[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m injects ## Detected with real commands into testing-standards [33m 1670[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m injects ## Detected into git-workflow with branch info [33m 1244[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m does not duplicate ## Detected on reinit [33m 2369[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m Path B: re-init preserves user-edited ## Gotchas (allowGotchaInjection semantic) [33m 2296[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m injects ### Library Rules into coding-standards Detected section [33m 1240[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m injects ### Common Issues into troubleshooting Detected section [33m 1408[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m re-init preserves ## Rules but replaces ## Detected [33m 2504[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/init/monorepoCommandScoping.test.ts [2m([22m[2m32 tests[22m[2m)[22m[32m 296[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/scan-engine-secrets.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 187[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:   Committed locally. Push failed after retry — run `git push`
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/polyglot.test.ts [2m([22m[2m37 tests[22m[2m)[22m[33m 481[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/commit-hygiene.test.ts [2m([22m[2m33 tests[22m[2m)[22m[33m 377[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/projectType.test.ts [2m([22m[2m19 tests[22m[2m)[22m[32m 198[2mms[22m[39m
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/run.test.ts [2m([22m[2m39 tests[22m[2m)[22m[32m 118[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/patterns/dependencies.test.ts [2m([22m[2m33 tests[22m[2m)[22m[32m 109[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/performance/benchmarks.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 238[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/entryPoints-go-rust.test.ts [2m([22m[2m8 tests[22m[2m)[22m[32m 115[2mms[22m[39m
anatomia-cli:test: Error: Wrong branch. Switch to `main` to close findings.
anatomia-cli:test:   Run: git checkout main
anatomia-cli:test:  [32m✓[39m tests/commands/agents-md.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 166[2mms[22m[39m
...
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/init/nonNodeCommands.test.ts [2m([22m[2m19 tests[22m[2m)[22m[32m 198[2mms[22m[39m
anatomia-cli:test: - Scanning project...
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/extraction.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 31[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/utils/capture-runner.test.ts [2m([22m[2m25 tests[22m[2m)[22m[32m 146[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/entryPoints-python.test.ts [2m([22m[2m12 tests[22m[2m)[22m[32m 130[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/testLocations.test.ts [2m([22m[2m13 tests[22m[2m)[22m[32m 102[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/utils/proof-parsers.test.ts [2m([22m[2m56 tests[22m[2m)[22m[32m 63[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/utils/update-check.test.ts [2m([22m[2m30 tests[22m[2m)[22m[32m 258[2mms[22m[39m
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/readme.test.ts [2m([22m[2m33 tests[22m[2m)[22m[33m 448[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/findings/validation.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 47[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/init-preflight.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 38[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/error-handling.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 121[2mms[22m[39m
...
anatomia-cli:test: [22m[39mℹ Dependencies not installed. Convention detection may be limited. Run npm install for deeper detection.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/init/preflight.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 229[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/utils/proof-health.test.ts [2m([22m[2m92 tests[22m[2m)[22m[32m 225[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/conventions/edge-cases.test.ts [2m([22m[2m8 tests[22m[2m)[22m[32m 108[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/findings/rules/validation.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 231[2mms[22m[39m
...
anatomia-cli:test:     at runWithTimeout (file:///Users/rsmith/Projects/anatomia_project/anatomia/.ana/worktrees/retire-capture-self-arming/node_modules/[4m.pnpm[24m/@vitest+runner@4.1.5/node_modules/[4m@vitest/runner[24m/dist/chunk-artifact.js:2272:10)
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/findings/secrets.test.ts [2m([22m[2m30 tests[22m[2m)[22m[32m 172[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/entryPoints-node.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 177[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/conventions/integration.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 156[2mms[22m[39m
anatomia-cli:test: [90mstdout[2m | tests/commands/artifact.test.ts[2m > [22m[2mana artifact save[2m > [22m[2m.saves.json metadata[2m > [22m[2moverwrites entry on re-save of same type
anatomia-cli:test: [90mstderr[2m | tests/commands/artifact.test.ts[2m > [22m[2mana artifact save[2m > [22m[2m.saves.json metadata[2m > [22m[2moverwrites entry on re-save of same type
anatomia-cli:test: [22m[39m✓ Saved Scope for `test-slug` to `main`.
anatomia-cli:test: 
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/integration/edge-cases.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 226[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/scanProject.test.ts [2m([22m[2m45 tests[22m[2m)[22m[33m 14886[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects stack from dependencies [33m 317[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects git info when repo exists [33m 657[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects external services and schemas [33m 815[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects Prisma schema in a monorepo sub-package [33m 520[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m extracts provider from non-anchor Prisma file [33m 360[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m ignores prisma directory with only SQL files [33m 502[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects Drizzle schema in a monorepo sub-package [33m 466[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m excludes Prisma schema in e2e directory from detection [33m 334[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m excludes Drizzle schema in examples directory from detection [33m 393[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m census reads drizzle.config.ts and extracts schema field [33m 440[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m census reads drizzle.config.js [33m 427[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m dialect from config is used as provider fallback [33m 405[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m counts pgTable calls as models [33m 319[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects postgresql provider from pgTable [33m 336[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects mysql provider from mysqlTable [33m 334[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m emits blind spot when drizzle-orm in deps but no schema [33m 334[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m no blind spot when schema found [33m 515[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m cross-ORM priority selects highest modelCount [33m 348[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m falls back to first-found when all modelCount are null [33m 357[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m counts surviving Supabase tables from schema-qualified SQL [33m 409[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m counts schema-qualified Supabase identifiers by final table segment [33m 445[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m counts surviving tables in generic SQL fallback [33m 336[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m keeps Prisma and Drizzle counts independent from SQL table counting [33m 414[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m barrel-index Drizzle schema aggregates tables from sibling files [33m 373[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m single-file schema with real tables is unchanged by barrel fallback [33m 301[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m env example in monorepo primary source root detected [33m 330[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/census.test.ts [2m([22m[2m7 tests[22m[2m | [22m[33m2 skipped[39m[2m)[22m[32m 139[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/detectors/commands.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 122[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test: ✔ Created ana.json
anatomia-cli:test:  [32m✓[39m tests/engine/findings/rules/errorBoundaries.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 57[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/utils/findProjectRoot.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 94[2mms[22m[39m
anatomia-cli:test: - Creating ana.json...
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/surfaces.test.ts [2m([22m[2m105 tests[22m[2m)[22m[32m 54[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/capture-corpus/invariants.test.ts [2m([22m[2m82 tests[22m[2m)[22m[32m 26[2mms[22m[39m
anatomia-cli:test: ✔ Created ana.json
anatomia-cli:test:  [32m✓[39m tests/utils/scan-freshness.test.ts [2m([22m[2m15 tests[22m[2m)[22m[32m 69[2mms[22m[39m
...
anatomia-cli:test: - Creating ana.json...
anatomia-cli:test: ✔ Created ana.json
anatomia-cli:test:  [32m✓[39m tests/commands/init/makeTestCommand.test.ts [2m([22m[2m35 tests[22m[2m)[22m[32m 166[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/data/rules-library.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 7[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/findings/errorBoundaries.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 116[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/check-dashboard.test.ts [2m([22m[2m34 tests[22m[2m)[22m[32m 299[2mms[22m[39m
...
anatomia-cli:test: [22m[39mWarning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/node.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 26[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/template-surface-awareness.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 54[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/conventions/indentation.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 9[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/utils/capture-marker.test.ts [2m([22m[2m20 tests[22m[2m)[22m[32m 19[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/scope-surface-validation.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 37[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/python.test.ts [2m([22m[2m35 tests[22m[2m)[22m[32m 25[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/data/troubleshooting-library.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 11[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/conventions/naming.test.ts [2m([22m[2m23 tests[22m[2m)[22m[32m 175[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/templates/cross-platform.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 9[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/census-detection.test.ts [2m([22m[2m22 tests[22m[2m)[22m[32m 12[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/applicationShape.test.ts [2m([22m[2m84 tests[22m[2m)[22m[32m 33[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/conventions/imports.test.ts [2m([22m[2m17 tests[22m[2m)[22m[32m 3[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/non-product-filtering.test.ts [2m([22m[2m38 tests[22m[2m)[22m[32m 12[2mms[22m[39m
...
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/conventions/imports.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 6[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/ai-sdk-detection.test.ts [2m([22m[2m42 tests[22m[2m)[22m[32m 9[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/parsing.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 9[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/patterns/confirmation.test.ts [2m([22m[2m42 tests[22m[2m)[22m[32m 10[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/setup-complete-integration.test.ts [2m([22m[2m4 tests[22m[2m)[22m[33m 413[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/go-rust.test.ts [2m([22m[2m8 tests[22m[2m)[22m[32m 5[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/templates/agent-proof-context.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 6[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/contract/analyzer-contract.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 8[2mms[22m[39m
...
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/patterns/performance.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 3[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/init-spinner.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 6[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/architecture-layered-ddd.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 4[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/injectors.test.ts [2m([22m[2m22 tests[22m[2m)[22m[32m 9[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/node-frameworks.test.ts [2m([22m[2m45 tests[22m[2m)[22m[32m 5[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/types.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 7[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/patterns/integration.test.ts [2m([22m[2m12 tests[22m[2m)[22m[32m 13[2mms[22m[39m
...
anatomia-cli:test: Run: git checkout main && git pull
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/architecture-discipline.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 53[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/conventions/http-method-filter.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 5[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/commands/scan-finding-details.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 12[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/dependencies.test.ts [2m([22m[2m38 tests[22m[2m)[22m[32m 6[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/node-package.test.ts [2m([22m[2m27 tests[22m[2m)[22m[32m 9[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/types/engineResult-partial.test.ts [2m([22m[2m13 tests[22m[2m)[22m[32m 11[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/utils/scaffold-generators.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 6[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/three-tier-detection.test.ts [2m([22m[2m21 tests[22m[2m)[22m[32m 4[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/engine/census-primary.test.ts [2m([22m[2m32 tests[22m[2m)[22m[32m 5[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/utils/validators.test.ts [2m([22m[2m16 tests[22m[2m)[22m[32m 5[2mms[22m[39m
...
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/engine/detectors/python-frameworks.test.ts [2m([22m[2m19 tests[22m[2m)[22m[32m 5[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/engine/analyzers/patterns/multiPattern.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 3[2mms[22m[39m
...
anatomia-cli:test:  [32m✓[39m tests/engine/parsers/ruby-php.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 6[2mms[22m[39m
...
anatomia-cli:test: 
anatomia-cli:test: - Scanning project...
anatomia-cli:test:  [32m✓[39m tests/commands/scan.test.ts [2m([22m[2m89 tests[22m[2m)[22m[33m 26150[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m scans current directory when no path provided [33m 641[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m scans specified path when path argument provided [33m 780[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m works on project without .ana/ directory [33m 763[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m produces valid JSON with --json flag [33m 916[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m JSON stack contains all category fields [33m 701[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m JSON files contains all count fields [33m 856[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m JSON structure is array of path/purpose objects [33m 813[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m creates no files during scan [33m 668[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m displays Language when detected [33m 490[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m displays Framework when detected [33m 464[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m omits Framework line entirely when not detected [33m 480[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m omits Database line entirely when not detected [33m 640[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m omits Auth line entirely when not detected [33m 671[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m displays Testing when test framework detected [33m 714[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m includes file counts in JSON output [33m 789[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m includes structure in JSON output [33m 1395[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m displays dynamic CTA in funnel context (no .ana/) [33m 865[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m writes scan.json with --save flag [33m 648[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m does not write scan.json without --save flag [33m 583[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m auto-creates .ana/ when --save used without init [33m 625[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m produces no stdout when --quiet used alone [33m 472[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m still produces JSON when --quiet --json combined [33m 738[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m forces surface tier with patterns and conventions null [33m 536[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m handles empty directory gracefully [33m 592[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m Workspace line does not include inline Surfaces sub-item [33m 311[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m renders Surfaces section with header and divider for monorepo [33m 307[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows surface name, framework/language, and testing on each line [33m 309[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows overflow indicator for 5+ surfaces [33m 344[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows no overflow for exactly 4 surfaces [33m 325[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m drops package count from summary when it would overflow [33m 569[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m displays active contributor count [33m 442[2mms[22m[39m
...
anatomia-cli:test: Warning: Push failed. Artifact committed locally. Run `git push` manually.
anatomia-cli:test: 
anatomia-cli:test:  [32m✓[39m tests/commands/artifact.test.ts [2m([22m[2m206 tests[22m[2m)[22m[33m 26984[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m parses scope type correctly [33m 302[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m allows build-report save on feature branch [33m 398[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m exits with already up to date on unchanged re-save [33m 351[2mms[22m[39m
...
anatomia-cli:test:   Path: /private/tmp/work-earlyret-test-BxUO5z
...
anatomia-cli:test: [22m[39mAlready in worktree for `my-feature`.
anatomia-cli:test:   Path: /private/tmp/work-earlyret-test-phY0wH
anatomia-cli:test:   Branch: main
anatomia-cli:test:   Commits: 0 since branch point
anatomia-cli:test: 
...
anatomia-cli:test: [22m[39mAlready in worktree for `my-feature`.
anatomia-cli:test:   Path: /private/tmp/work-earlyret-test-SRmqnG
anatomia-cli:test:   Branch: main
anatomia-cli:test:   Commits: 0 since branch point
anatomia-cli:test: 
...
anatomia-cli:test: [22m[39mAlready in worktree for `my-feature`.
anatomia-cli:test:   Path: /private/tmp/work-earlyret-test-AZ5ySz
anatomia-cli:test:   Branch: main
anatomia-cli:test:   Commits: 0 since branch point
anatomia-cli:test: 
...
anatomia-cli:test:  [32m✓[39m tests/commands/work.test.ts [2m([22m[2m235 tests[22m[2m)[22m[33m 47577[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with feature branch + build_report → ready-for-verify [33m 375[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with verify_report PASS → ready-to-merge [33m 358[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with verify_report FAIL → needs-fixes [33m 372[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with verify_report no Result line → verify-status-unknown [33m 666[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with FAIL verify + build saved after verify via .saves.json → ready-for-re-verify [33m 613[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with FAIL verify + build saved BEFORE verify via .saves.json → needs-fixes [33m 369[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m full FAIL-fix-re-verify stage progression single-spec [33m 537[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m with build_report_1, no verify_report_1 → phase-1-ready-for-verify [33m 586[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m verify_report_1 PASS, no build_report_2 → phase-2-ready-for-build [33m 415[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m all verify_reports PASS → ready-to-merge [33m 418[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m multi-phase FAIL on phase 2 + fix build saved after verify → phase-2-ready-for-re-verify [33m 358[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m full FAIL-fix-re-verify stage progression multi-phase [33m 581[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m multi-phase stage detection does not fall back to unnumbered saves.json keys for phase 2 [33m 599[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m multi-phase stage detection falls back to unnumbered saves.json keys for phase 1 [33m 379[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m work status shows behind warning when worktree is behind origin/main [33m 386[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m work status does NOT show behind warning when worktree is fresh [33m 375[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m work status --json includes commitsBehind in worktree info [33m 428[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m ready-to-merge next action renders with per-line arrow prefix [33m 384[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m getNextAction returns array for ready-to-merge in JSON output [33m 314[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m getWorkStatus returns clean workBranch for worktree-checked-out branch [33m 329[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m work complete uses configured prefix for branch cleanup [33m 426[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m completes single-spec work with PASS [33m 435[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m completes multi-spec work (3 phases) with all PASS [33m 382[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m succeeds even if feature branch was already deleted [33m 375[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m excludes unrelated staged files from the complete commit [33m 533[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m succeeds when on artifact branch [33m 468[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m exits successfully when slug already completed [33m 314[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m writes worktree metadata to proof chain entry when worktree exists [33m 322[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m prints nonzero finding count when verify report has findings [33m 319[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m shows finding delta when new findings exist [33m 318[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m does not supersede findings on same file+category [33m 308[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m does not close findings with partial monorepo paths [33m 309[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m assigns active status to new code findings, closed to upstream [33m 304[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m no health line when new entry is unmeasurable [33m 301[2mms[22m[39m
anatomia-cli:test:          [33m[2m✓[22m[39m highest priority nudge wins when multiple triggers fire [33m 321[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m removes build/verify artifacts unconditionally during work complete [33m 568[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m removes build/verify data companions unconditionally during work complete [33m 575[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m keeps content-match guard for planning artifacts during work complete [33m 344[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m handles mixed untracked files with split cleanup strategy [33m 584[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m detects merge via gh when is-ancestor fails [33m 433[2mms[22m[39m
anatomia-cli:test:      [33m[2m✓[22m[39m falls back to is-ancestor when gh unavailable [33m 496[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m recent verify_started_at_1 does not affect Phase 2 status [33m 463[2mms[22m[39m
anatomia-cli:test:  [32m✓[39m tests/commands/proof.test.ts [2m([22m[2m270 tests[22m[2m)[22m[33m 48636[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows satisfied/total ratio [33m 333[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m outputs valid JSON with 4-key contract envelope [33m 331[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns empty entries array when file missing [33m 549[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m no truncation message when exactly 5 findings [33m 323[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m does not show Findings header when no findings [33m 392[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows total pipeline time [33m 339[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows what was done instead [33m 335[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns error when proof_chain.json missing [33m 433[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m suggests using work complete [33m 530[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m uses box-drawing characters for header [33m 441[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m uses horizontal rules for section headers [33m 435[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m selects correct entry from multiple entries [33m 343[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows unsatisfied assertions with X icon [33m 324[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m marks finding as closed with reason [33m 374[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows FINDING_NOT_FOUND error [33m 384[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns ALREADY_CLOSED code in JSON [33m 348[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m shows REASON_REQUIRED error [33m 372[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns REASON_REQUIRED code in JSON [33m 362[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns 4-key envelope with finding and meta [33m 380[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m returns ALREADY_PROMOTED with promoted_to path [33m 331[2mms[22m[39m
anatomia-cli:test:        [33m[2m✓[22m[39m retries push after pull when push fails [33m 529[2mms[22m[39m
anatomia-cli:test: 
anatomia-cli:test: [2m Test Files [22m [1m[32m138 passed[39m[22m[90m (138)[39m
anatomia-cli:test: [2m      Tests [22m [1m[32m3432 passed[39m[22m[2m | [22m[33m2 skipped[39m[90m (3434)[39m
anatomia-cli:test: [2m   Start at [22m 03:20:37
anatomia-cli:test: [2m   Duration [22m 49.12s[2m (transform 5.78s, setup 0ms, import 14.97s, tests 274.81s, environment 7ms)[22m
anatomia-cli:test: 
